...
/**
 * Upgrade code for the imageselect question type.
 ...
 */
function xmldb_qtype_imageselect_upgrade($oldversion = 0) {
    global $CFG, $DB;
    ...
    if( !$dbman->table_exists('question_imageselect_feedback')){
            $table = new xmldb_table('question_imageselect_feature');
    ...
    upgrade_plugin_savepoint(true, 2006082519, 'qtype', 'imageselect');
